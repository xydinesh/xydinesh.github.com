...
- [1. Embrace the reality and deal with it](#section-1)
- [2. Five step process](#section-2)
- [3. Be Radically Open-Minded](#section-3)
- [4. People are wired differently](#section-4)
- [5. Learn to make decisions effectively](#section-5)

## 1. Embrace the reality and deal with it <a id="section-1"></a>
...
## 2. Five step process <a id="section-2"></a>
**Have clear goals**
...
**Understand your mental maps & humility**
	- Humility can be better than having better mental maps if that could lead to find better answers than one you can come up with your own

## 3. Be Radically Open-Minded<a id="section-3"></a>
...
## 4. People are wired differently<a id="section-4"></a>
...
## 5. Learn to make decisions effectively<a id="section-5"></a>
